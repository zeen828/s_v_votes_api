...
$config['mongo_db']['user']['port'] = '27017';
$config['mongo_db']['user']['username'] = 'username';
$config['mongo_db']['user']['password'] = 'password';
$config['mongo_db']['user']['database'] = 'database';
$config['mongo_db']['user']['db_debug'] = TRUE;
$config['mongo_db']['user']['return_as'] = 'array';
$config['mongo_db']['user']['write_concerns'] = (int)1;
